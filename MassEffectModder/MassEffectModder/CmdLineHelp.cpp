...
void DisplayHelp()
{
    ...
    PINFO("              DXT1, DXT3, DTX5, ATI2, V8U8, G8, ARGB, RGB\n");
    PINFO("           input format supported for TGA images:\n");
    PINFO("              uncompressed ARGB/RGB, compressed ARGB/RGB\n");
    PINFO("           input format supported for BMP images:\n");
    PINFO("              uncompressed ARGB/RGB/RGBX\n");
    ...
    PINFO("     output pixel format: DXT1 (no alpha), DXT1a (alpha), DXT3, DXT5, ATI2, V8U8, G8, ARGB, RGB\n");
