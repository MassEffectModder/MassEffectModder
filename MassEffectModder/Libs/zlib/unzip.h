...
extern unzFile unzOpenIoMem(voidpf stream, zlib_filefunc64_def* pzlib_filefunc64_def, int is64bitOpenFunction);
extern unzFile unzOpenIoFile(const void *path, zlib_filefunc64_def* pzlib_filefunc_def);
