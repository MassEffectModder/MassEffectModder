...
static SRes SzDecodeLzmaStream(const Byte *props, unsigned propsSize, UInt64 packedSize, ILookInStreamPtr inStream,
...
static SRes SzDecodeLzma2Stream(const Byte *props, unsigned propsSize, UInt64 packedSize, ILookInStreamPtr inStream,
                                SizeT unpackSize, SzArEx_StreamOutEntry *streamOutInfo, UInt32 folderIndex,
                                ISzAllocPtr allocMain, UnpackProgressCallback callbackProgress, UnpackCurFileCallback curFile)
{
    CLzma2Dec state;
...
static SRes SzDecodeCopyStream(UInt64 inSize, ILookInStreamPtr inStream, SzArEx_StreamOutEntry *streamOutInfo,
