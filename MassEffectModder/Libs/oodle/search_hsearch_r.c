...
/* Before using the hash table we must allocate memory for it.
   ...
   becomes zero.  */
int
pe_hcreate_r (size_t nel, struct pe_hsearch_data *htab)
{
...
void
pe_hdestroy_r (struct pe_hsearch_data *htab)
{
  /* Test for correct arguments.  */
  if (htab == NULL)
  {
...
int
pe_hsearch_r (ENTRY item, ACTION action, ENTRY **retval,
              struct pe_hsearch_data *htab)
{
  unsigned int hval;
  unsigned int count;
